...
local new_hint_content = "This rate changes based upon the number of Headhunting rolls.For more details, see <color=#00C8FF>[Standard Headhunting]</color> below."
